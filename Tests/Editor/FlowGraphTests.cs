...
namespace PixoVR.TrainingCore.Tests
{
    ...
    public class ApexSessionTests
    {
        private class FakeClient : Apex.IApexClient
        {
            ...
            public void Login(string u, string p, System.Action<bool, string> done) { LoggedIn = true; done(true, null); }
            public void LoginWithToken(string t, System.Action<bool, string> done) { LoggedIn = true; done(true, null); }
            public void QuickIdLogin(string s, string u, System.Action<bool, string> done) { LoggedIn = true; done(true, null); }
